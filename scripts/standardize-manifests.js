...
function processApp(appDir) {
    ...
    try {
        ...
        const newNeoManifest = {
            ...
            entry_url: srcManifest.entry_url || neoManifest.entry_url || `/miniapps/${appDir}/index.html`,
            ...
            permissions: srcManifest.permissions || neoManifest.permissions || { wallet: ['read-address'] },
