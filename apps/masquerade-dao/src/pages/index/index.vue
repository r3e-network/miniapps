      ...
      <view v-if="chainType === 'evm'" class="px-4 mb-4">
        <NeoCard variant="danger">
          <view class="flex flex-col items-center gap-2 py-1">
            <text class="text-center font-bold mask-warning-title">{{ t("wrongChain") }}</text>
            <text class="text-xs text-center opacity-80 mask-warning-desc">{{ t("wrongChainMessage") }}</text>
