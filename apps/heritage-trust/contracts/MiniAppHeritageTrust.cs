...
namespace NeoMiniAppPlatform.Contracts
{
    ...
    public partial class MiniAppHeritageTrust : MiniAppBase
    {
        ...
        public struct Trust
        {
            ...
            public BigInteger Principal;        // NEO Principal
            public BigInteger GasPrincipal;     // GAS Principal
            public BigInteger AccruedYield;
            public BigInteger ClaimedYield;
            public BigInteger MonthlyNeoRelease; // Monthly NEO to release after trigger
            public BigInteger MonthlyGasRelease; // Monthly GAS to release after trigger
            public bool OnlyReleaseRewards;      // If true, only release GAS rewards, keep NEO principal
            public BigInteger LastReleaseTime;   // Last time beneficiary claimed release
            public BigInteger TotalNeoReleased;  // Total NEO beneficiary has claimed
            public BigInteger TotalGasReleased;  // Total GAS beneficiary has claimed
